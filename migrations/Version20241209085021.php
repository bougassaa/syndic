 ...
 */
final class Version20241209085021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cotisation (id INT AUTO_INCREMENT NOT NULL, appartement_id INT NOT NULL, proprietaire_id INT DEFAULT NULL, paid_at DATE NOT NULL, montant DOUBLE PRECISION NOT NULL, INDEX IDX_AE64D2EDE1729BBA (appartement_id), INDEX IDX_AE64D2ED76C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cotisation_tarif (cotisation_id INT NOT NULL, tarif_id INT NOT NULL, INDEX IDX_BA04510E3EAA84B1 (cotisation_id), INDEX IDX_BA04510E357C0A59 (tarif_id), PRIMARY KEY(cotisation_id, tarif_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_depense (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(300) NOT NULL, montant DOUBLE PRECISION NOT NULL, frequence VARCHAR(50) DEFAULT NULL COMMENT \'Fréquence de dépenses (mensuelle, annuelle ou null pour ponctuelle)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cotisation_tarif ADD CONSTRAINT FK_BA04510E3EAA84B1 FOREIGN KEY (cotisation_id) REFERENCES cotisation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cotisation_tarif ADD CONSTRAINT FK_BA04510E357C0A59 FOREIGN KEY (tarif_id) REFERENCES tarif (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cotisation_tarif DROP FOREIGN KEY FK_BA04510E3EAA84B1');
        $this->addSql('ALTER TABLE cotisation_tarif DROP FOREIGN KEY FK_BA04510E357C0A59');
        ...
        $this->addSql('DROP TABLE cotisation_tarif');
